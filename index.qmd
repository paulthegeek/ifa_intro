...
The traditions, practices, and spritual system of the Yoruba people of West Africa. It's a system of divination, ethics, cosmology, and a way of life. Ifá is one the oldest spritual traditions in the world, predating many of the most practiced religions and spritiual systems of the world. Ifá is the root of many of the African Traditional Religions (ATR) such as Santería, Candomblé, and Vodun. The divniation system is based on the Holy Odu which consists of 256 Odu (chapters). They are broken down into 16 major Odu and 246 minor Odu, with each containing many ẹsẹ (verses). The Holy Odu states that we all have a chosen destiny that we must fulfill. As Chief Solagbade Popoola says "If you seek the truth, come to Ifá."

## Who is Olódùmarè?
Olódùmarè is the creator and source of all that is in the universe.

## What are [Órìṣà](orisha.qmd)?
